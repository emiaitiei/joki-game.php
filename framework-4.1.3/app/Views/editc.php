      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h2>Edit Costumer</h2>
            <form action="<?= base_url ('home/simpan_costumer') ?>" method="post">
              ...
              <input type="hidden" value="<?=$ngok->id_user?>" name="idu">
              <input type="hidden" value="<?=$ngok->id_costumer?>" name="idc"> 

              <button type="submit" class="btn btn-primary">Submit</button>

              <td>
                <a href="<?= base_url('home/hapus_costumer/'.$ngok->id_user) ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
              </td>
