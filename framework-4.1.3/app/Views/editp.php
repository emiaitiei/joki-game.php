      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h2>Edit Penjoki</h2>
            <form action="<?= base_url ('home/simpan_penjoki') ?>" method="post">
              ...
              <input type="hidden" value="<?=$ngok->id_penjoki?>" name="idp"> 

              <button type="submit" class="btn btn-primary">Submit</button>

              <td>
                <a href="<?= base_url('home/hapus_penjoki/'.$ngok->id_user) ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
              </td>
